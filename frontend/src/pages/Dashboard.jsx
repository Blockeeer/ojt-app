...
import { summarizeAttendance } from '../utils/timeCalculator';
import {
  getTodayStr,
          ...
          {todayHoliday && (
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5 capitalize">{todayHoliday.type} holiday</p>
              </div>
            </div>
          )}
            ...
            <div className="flex items-center gap-2 bg-emerald-50 border border-emerald-100 rounded-xl p-3">
              ...
              <div>
                ...
                <p className="text-xs text-emerald-600">
                  {todayRecord.renderedHours > 0 ? `${todayRecord.renderedHours}h recorded` : 'Marked absent'}
                </p>
              </div>
            </div>
          ) : (
